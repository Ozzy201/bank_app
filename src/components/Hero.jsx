...
const Hero = () => (
        ...
        <section id="home" className={`flex md:flex-row flex-col sm:w-[90%] w-[100%] sm:mx-10 ml-0`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
          ...
          <div className='flex flex-row justify-between items-center w-full '>
            ...
            text-[52px] text-white ss:leading-[80px] leading-[55px] '>The Next <br className='sm:block hidden' />
            {" "}
          ...
          <h1 className='font-poppins font-semibold ss:text-[58px] 
            text-[52px] text-white ss:leading-[80px] leading-[55px]
            w-full '>
            Payment Method.
             </h1>
